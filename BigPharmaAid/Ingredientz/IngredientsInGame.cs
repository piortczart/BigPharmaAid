...
{
    public class IngredientsInGame
    {
        public static readonly Ingredient One = new Ingredient(
            "Green Poo",
            12,
            37,
            new EffectTree[]
            {
                EmptyEffectTree.Empty,
                new SideEffectTree
                {
        ...
        public static readonly Ingredient Two = new Ingredient(
            "Purple Flask",
            7,
            37,
            new EffectTree[]
        ...
        public static readonly Ingredient Three = new Ingredient(
            "Green Cube",
            14,
            34,
            new EffectTree[]
        ...
        public static readonly Ingredient Four = new Ingredient(
            "Yellow Diamond",
            14,
            35,
            new EffectTree[]
        ...
        public static Ingredient Five = new Ingredient(
            "Purple Extinguisher",
            10,
            35,
            new EffectTree[]
        ...
        public static Ingredient Six = new Ingredient(
            "Red Poo",
            9,
            35,
            new EffectTree[]
        ...
        public static Ingredient Seven = new Ingredient(
            "Purple Crystals",
            14,
            36,
            new EffectTree[]
